...
function registerUsername() {
	if($('#username').length === 0) {
		...
		myusername = username;
		sfutest.send({ message: register }, (res)=>{console.log(res);});
		
	}
}

// sfutest.send({ message: { request: "rtp_forward", room: myroom, publisher_id : 3452537856645810, host : "localhost", simulcast: true, secret: "adminpwd"}})
